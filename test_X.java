...
public class test_X extends JFrame implements ActionListener {
    ...
    public test_X() {
        ...
        try {
            image = ImageIO.read(new File("pyramid__water.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        triangleButton.setBounds(580, 690, 100, 20);
        ...
        parallelogramButton.setBounds(285, 470, 45, 45);
